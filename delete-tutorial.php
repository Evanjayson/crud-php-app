...
if(isset($_POST["delete-tutorial"]))  
 {  
	      ...
	      if($delete_record->delete_specific_record('tutorials','tutorial_id',$_POST['tutorial_id']))
          {
		   $success_message = 'Tutorial Deleted';
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
       <button type="submit" name="delete-tutorial" class="btn btn-danger btn-lg" style="width: 40%;"> Delete Tutorial</button>
      </div>
    </div>
  </div>
</div>  
