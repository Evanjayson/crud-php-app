...
if(isset($_GET["subject"]))  
 ...
 {  
	      ...
	      if($delete_record->delete_specific_record('subjects', 'subject_id', $_POST['subject_id']))
          {
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
       <button type="submit" name="delete-subject" class="btn btn-danger btn-lg" style="width: 40%;"> Delete Subject</button>
      </div>
    </div>
  </div>
</div>  
